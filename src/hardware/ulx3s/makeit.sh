...
VHDLS="datatypes.vhd top.vhd cpu/cpu.vhd cpu/regfile_wide.vhd cpu/execunit.vhd cpu/eu_mem.vhd mmu.vhd ${PERIPHERALS_VHDLS[@]}" #  gpio.vhd timebase.vhd hdmi.vhd ram.vhd "
