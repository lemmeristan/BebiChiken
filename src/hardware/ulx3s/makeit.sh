...
VHDLS="datatypes.vhd top.vhd cpu/cpu.vhd cpu/regfile_dpram/regfile_dpram.vhd cpu/eu_mem.vhd mmu.vhd cpu/eu_i_type.vhd cpu/eu_branch_type.vhd cpu/eu_r_type.vhd    ${PERIPHERALS_VHDLS[@]}" # cpu/eu_u_type.vhd cpu/regfile_half.vhd  gpio.vhd timebase.vhd hdmi.vhd ram.vhd " # cpu/eu_b_type.vhd cpu/eu_i_type.vhd cpu/eu_j_type.vhd cpu/eu_r_type.vhd cpu/eu_u_type.vhd 
