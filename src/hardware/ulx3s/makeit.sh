...
VERILOGS="${PERIPHERALS_VERILOGS[@]} cpu/regfile_dpram/dp16kd_wrapper.v  cpu/regfile_dpram/dpram_regfile_lattice.v " # HDMI_test_hires.v HDMI_clock.v TMDS_encoder.v"
